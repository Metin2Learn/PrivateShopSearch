...
Add it under:
RemoveFromMysql(ch->GetPlayerID(), bPos);
...
Add it under:
	InsertInMysql(ch, pkItem, bPos, iPrice);
...
Add it under:
RemoveAllItemsFromMysql(offlineShop.dwRealOwner);

---

Add in the bottom of the page:

void COfflineShopManager::RemoveAllItemsFromMysql(DWORD dwSellerPID){
...
void COfflineShopManager::RemoveFromMysql(DWORD dwSellerPID, BYTE bPos){
...
void COfflineShopManager::InsertInMysql(LPCHARACTER lpSeller, LPITEM item, BYTE bPos, DWORD dwItemPrice)
{
